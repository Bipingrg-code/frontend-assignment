        ...
        <div>
            <header className="body-font shadow-lg">
                <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                    <a className="flex title-font font-medium items-center text-slate-700 mb-4 md:mb-0">
                    ...
                    <nav className=" text-slate-500 md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
                        <a className="mr-5 hover:text-slate-800">First Link</a>
                        <a className="mr-5 hover:text-slate-800">Second Link</a>
                        <a className="mr-5 hover:text-slate-800">Third Link</a>
                        <a className="mr-5 hover:text-slate-800">Fourth Link</a>
                    </nav>
