...
const Cart = () => {
    ...
    if (carts.length === 0) {
        return <div className='h-[55vh] text-center text-red-500 pt-10'>Cart is Empty..!</div>
    }
        ...
        <div className="container mx-auto mt-10">
            <div className="flex shadow-md my-10">
                <div className="w-3/4 bg-white px-10 py-10">
                                ...
                                <div className="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
                                    <div className="flex w-2/5">
                                        ...
                                        <div className="flex flex-col justify-between ml-4 flex-grow">
                                            ...
                                            <span className="text-indigo-500 text-xs">{cart?.category}</span>
                                            <div className="font-semibold hover:text-red-500 text-red-400 text-xs cursor-pointer" onClick={() => removeProducts(cart?.id)}>Remove</div>
                                        </div>
                                    </div>
                                    ...
                                    <span className="text-center w-1/5 font-semibold text-sm">Rs.{cart?.price}</span>
                                    <span className="text-center w-1/5 font-semibold text-sm">Rs. {cart?.price * cart?.quantity}</span>
                                </div>
                            )
                        })
                    }
                    ...
                    <Link to={'/products'} href="#" className="flex font-semibold text-indigo-600 text-sm mt-10">
                ...
                <div id="summary" className="w-1/4 px-8 py-10">
                    ...
                    <button className="bg-indigo-500 hover:bg-indigo-500 px-5 py-2 text-sm text-white uppercase">Apply</button>
